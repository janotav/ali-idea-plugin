...
public class MultipleItemsChooserFactory extends MultipleItemsFactory {
    ...
    public MultipleItemsChooserFactory(Project project, String title, boolean multiple, ItemsProvider<ComboItem> items) {
        this(project, title, multiple, items, null);
    }

    public MultipleItemsChooserFactory(Project project, String title, boolean multiple, ItemsProvider<ComboItem> items, Translator translator) {
