...
import com.hp.alm.ali.idea.ui.dialog.ChangesDialog;
...
public class ShowChangesAction extends EntityAction {
    ...
    public ShowChangesAction() {
        super("Code Changes", "Show related code changes", IconLoader.getIcon("/diff/Diff.png"));
    }
    ...
    protected boolean visiblePredicate(Project project, String entityType) {
        ...
        if(serverType.isConnected()) {
            return serverType != ServerType.ALM11;
        } else {
            return false;
        }
    }
    ...
    protected void actionPerformed(AnActionEvent event, Project project, Entity entity) {
        ChangesDialog changesDialog = new ChangesDialog(project, new EntityRef(entity));
