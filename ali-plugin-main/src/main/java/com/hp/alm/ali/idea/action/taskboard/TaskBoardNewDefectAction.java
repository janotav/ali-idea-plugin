...
public class TaskBoardNewDefectAction extends SprintScopedAction {

    public TaskBoardNewDefectAction() {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        if(project != null) {
            ...
            new DefectEditor(project, releaseId, sprintId, teamId).execute();
        }
    }
}
