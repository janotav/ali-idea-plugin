...
public class BacklogStatusDefectType implements DependentValue {

    private static Map<String, String> map;
    static {
        map = new HashMap<String, String>();
        map.put("New", "New");
        map.put("In Progress", "Open");
        map.put("In Testing", "Fixed");
        map.put("Done", "Closed");
    }

    @Override
    public void valueChanged(EntityEditor editor, String value) {
        editor.setFieldValue("status", map.get(value), false);
    }
}
