...
public class TaskEditAction extends EntityAction {

    public TaskEditAction() {
        super("Edit", "Edit task", IconLoader.getIcon("/actions/editSource.png"));
    }
    ...
    protected void actionPerformed(AnActionEvent event, Project project, Entity entity) {
        TaskEditor taskEditor = new TaskEditor(project, entity);
        taskEditor.execute();
    }
}
