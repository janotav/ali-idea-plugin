...
public class ReleaseStep extends GenesisStep {
    ...
    public void _init() {
        ...
        ServerType type = AliConfigurable.getServerType(ctx.location.getText(), (String) ctx.domain.getSelectedItem(), (String) ctx.project.getSelectedItem(), ctx.username.getText(), ctx.password.getText());
        if(type == ServerType.ALI || type == ServerType.ALI2 || type.isApollo()) {
