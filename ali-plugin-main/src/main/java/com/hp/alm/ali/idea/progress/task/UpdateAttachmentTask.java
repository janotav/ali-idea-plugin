...
public class UpdateAttachmentTask extends Task.Backgroundable {
    ...
    public UpdateAttachmentTask(Project project, File file, String filename, String name, String description, EntityRef parent) {
