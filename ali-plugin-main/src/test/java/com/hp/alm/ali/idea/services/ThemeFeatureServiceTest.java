...
public class ThemeFeatureServiceTest extends IntellijTest {
    ...
    public void testGetFeatures() {
        handler.addRequest("GET", "/qcbin/rest/domains/domain/projects/project/requirements?fields=id,name,release-backlog-item.id&query={type-id[71]}&order-by={name[ASC]}&page-size=1000", 200)
    ...
    public void testGetFeatures_filter() {
        handler.addRequest("GET", "/qcbin/rest/domains/domain/projects/project/requirements?fields=id,name,release-backlog-item.id&query={name[Uno]; type-id[71]}&order-by={name[ASC]}&page-size=1000", 200)
    ...
    public void testGetThemes() {
        handler.addRequest("GET", "/qcbin/rest/domains/domain/projects/project/requirements?fields=id,name,release-backlog-item.id&query={type-id[72]}&order-by={name[ASC]}&page-size=1000", 200)
    ...
    public void testGetThemes_filter() {
        handler.addRequest("GET", "/qcbin/rest/domains/domain/projects/project/requirements?fields=id,name,release-backlog-item.id&query={name[Uno]; type-id[72]}&order-by={name[ASC]}&page-size=1000", 200)
