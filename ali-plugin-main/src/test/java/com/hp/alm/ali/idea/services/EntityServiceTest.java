...
public class EntityServiceTest extends MultiTest {
    ...
    public void testQuery() {
        ...
        handler.addRequest(false, "GET", "/qcbin/rest/domains/domain/projects/project/defects?fields=priority,release-backlog-item.id,release-backlog-item.blocked&query={status[\"Fixed\"]}&order-by={priority[DESC]}", 200)
                .content("entityServiceTest_entity.xml");
